...
if __name__ == '__main__':
    tokenizer = BertTokenizer.from_pretrained("./www-bert-chinese/")
    ...
    parser.add_argument("--max_ent_len", default=64,type=int)
    parser.add_argument("--content_length", default=256,type=int)
    parser.add_argument("--change_kb",default=True)

    parser.add_argument("--train_data", default="train_dev.json")
