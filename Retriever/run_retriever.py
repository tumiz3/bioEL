...
if __name__ == '__main__':
    ...
    parser.add_argument('--model',
                        default="model_retriever/aier_retriever.pt",
                        help='model path')
    parser.add_argument("--pretrained_model",
                        default="./www-bert-chinese/")
    ...
    parser.add_argument('--B', type=int, default=2,#应该是2
    ...
    parser.add_argument('--mention_bsz', type=int, default=32,
                        help='the batch size')
    parser.add_argument('--entity_bsz', type=int, default=32,
                        help='the batch size')
    ...
    parser.add_argument('--cands_embeds_path', type=str,
                        default="dataset/aier_data/candidates_embeds/candidate_embeds.npy",
